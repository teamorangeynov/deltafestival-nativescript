import { AfterContentInit, Component, OnInit, OnDestroy, ChangeDetectorRef } from "@angular/core";
...
@Component({
    selector: "tinderLike",
    moduleId: module.id,
    templateUrl: "./tinderLike.component.html",
    styleUrls: ['./tinderLike.component.css']
})
export class TinderLikeComponent implements OnInit, AfterContentInit {
